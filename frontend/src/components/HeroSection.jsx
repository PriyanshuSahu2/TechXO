...
export default function HeroSection(prop) {
    ...
    return (
        <div id="default-carousel" className="relative w-[95%] m-auto mt-8" data-carousel="slide" >
            <div className="relative h-56 overflow-hidden rounded-lg md:h-80 ">
                ...
                <div className=" text-white bg-transparent p-10 left-16 top-[50%] -translate-y-[50%] text-left w-[500px] absolute z-40 ">
